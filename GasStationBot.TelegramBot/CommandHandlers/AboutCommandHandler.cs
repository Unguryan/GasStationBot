...
namespace GasStationBot.TelegramBot.CommandHandlers
{
    public class AboutCommandHandler : BaseTelegramCommandHandler<AboutCommand>
    {
        ...
        protected override string Message => "Цей телеграм бот, який сам слідкує за паливом на АЗС, та сповіщає вас, коли необхідне вам паливо з'явилось, або закінчилось.\n" +
